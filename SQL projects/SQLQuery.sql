...
insert into diabetes_prediction (EmployeeName,Patient_id, age, gender, smoking_history, hypertension, heart_disease, bmi, HbA1c_level, blood_glucose_level, diabetes) 
values (95478, 'Ali', 35, 'Male', 'Non-smoker', 0, 0, 'never', 26.1499996185303, 3.5, 126, 0);
...
values ('Ali', 'Ali', 35, 'Male', 'Non-smoker', 0, 0, 26.0, 3.0, 126.0, 0);
